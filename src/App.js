...
import { BrowserRouter as Router, Routes, Route, Navigate } from 'react-router-dom';
import { LayoutDashboard, FileText, Archive, Settings, Shield } from 'lucide-react';
    ...
    <Router>
      <div className="min-h-screen bg-gray-50">
        <Routes>
          ...
          <Route path="/" element={<DashboardLayout navigation={navigation}><Dashboard /></DashboardLayout>} />
          <Route path="/coi" element={<DashboardLayout navigation={navigation}><COIandFormTracker /></DashboardLayout>} />
          <Route path="/archive" element={<DashboardLayout navigation={navigation}><ArchivePage /></DashboardLayout>} />
          <Route path="/form_templates" element={<DashboardLayout navigation={navigation}><FormTemplatesScreen /></DashboardLayout>} />
